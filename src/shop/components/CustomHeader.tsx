...
export const CustomHeader = () => {
  ...
  const handleSearch = (event: KeyboardEvent<HTMLInputElement>) => {
    ...
    //creamos una variable provisional para almacenar los parametros URL
    const newSearchParams = new URLSearchParams();
    //si la query no se encuentra vacia al presionar enter
    if (!query) {
      newSearchParams.delete('query');
    } else {
      //generamos un parametro URL nuevo llamado 'query' con el valor de la busqueda, en el "URL provisional"
      newSearchParams.set('query', inputRef.current!.value);
    }        
    
    //sobreescribimos la URL real con el valor de la URL provisional que creamos arriba
